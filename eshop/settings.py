...
##check if our app is using aws s3 otherwise use whitenoise to handle staticfiles
...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'eshop.storage_backends.StaticStorage'
      # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'eshop.storage_backends.PublicMediaStorage'
else:
    STATIC_URL = '/static/'
